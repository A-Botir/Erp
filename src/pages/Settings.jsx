          ...
          <table className="w-full rounded-md border border-[#E5E9EB] py-2 ">
            <thead>
              <tr className="border-b border-[#E5E9EB]">
                ...
                <th className="py-2 text-left font-semibold">Описание</th>
                <th className="py-2 font-semibold">Год основания</th>
                <th className="py-2"></th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b border-[#E5E9EB]">
                <td className="px-2 py-2 ">L'Oréal</td>
                <td className="py-2 ">
                  In the eighteenth century the German philosopher Immanuel Kant
                  developed a theory of knowledge in...
                </td>
                <td className="text-center">2008</td>
