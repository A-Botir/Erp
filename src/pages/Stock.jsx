      ...
      <table className="w-full rounded-md border border-[#E5E9EB] py-2 ">
        <thead>
          <tr className="border-b border-[#E5E9EB]">
            ...
            <th className="py-2 font-semibold">Начало акции</th>
            <th className="font-semibold">Конец акции</th>
        ...
        <tbody>
          ...
          <tr className="border-b border-[#E5E9EB]">
            ...
            <td className="py-2 text-center">10.06.2021</td>
            <td className="py-2 text-center">01.09.2021</td>
            <td>
            ...
            <td className="flex justify-end">
              <button className="shadow-tdbtn px-2 py-3">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
